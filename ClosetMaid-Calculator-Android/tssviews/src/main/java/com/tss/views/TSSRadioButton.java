...
public class TSSRadioButton extends RadioButton implements OnGlobalLayoutListener{

    public TSSRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(w!=measuredWidth||h!=measuredHeight){
            ...
            if(w!=0&&h!=0){
                calculateMargins();
                RadioGroup.LayoutParams params=(RadioGroup.LayoutParams)getLayoutParams();
